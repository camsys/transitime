 ...
 */
public class AwsCloudWatchMonitoringServiceImpl implements MonitoringService{
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(AwsCloudWatchMonitoringServiceImpl.class);
    ...
    public AwsCloudWatchMonitoringServiceImpl() {
    ...
    public static void main(String[] args){
        AwsCloudWatchMonitoringServiceImpl cloudwatchService = new AwsCloudWatchMonitoringServiceImpl();
        int i = 0;
        while (i < 100){
