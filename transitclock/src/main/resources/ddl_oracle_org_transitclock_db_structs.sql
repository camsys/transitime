create sequence hibernate_sequence start with 1 increment by  1;
    ...
    create table TravelTimesForTrip_to_TravelTimesForPath_joinTable (
       TravelTimesForTrip_id number(10,0) not null,
        travelTimesForStopPaths_id number(10,0) not null,
        listIndex number(10,0) not null,
        primary key (TravelTimesForTrip_id, listIndex)
    );
    ...
    create table TripPattern_to_Path_joinTable (
       TripPattern_id varchar2(120 char) not null,
        TripPattern_configRev number(10,0) not null,
        ...
        listIndex number(10,0) not null,
        primary key (TripPattern_id, TripPattern_configRev, listIndex)
    );
